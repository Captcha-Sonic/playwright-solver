 ...
 * The extension auto-detects and solves Turnstile challenges.
 *
 * Setup:
 *   1. Copy .env.example to .env and add your API key + extension path
 *   2. npm run turnstile:ext
...
async function main() {
  console.log('🔊 CaptchaSonic — Cloudflare Turnstile Extension Method (Playwright)');
